...
function wt_note_config() {
	...
	"description" => "اطلاع رسانی به مدیر و پشتبانان سایت از طریق تلگرام - طراحی و کدنویسی شده توسط امیرحسین فریدوند",
	"version" => "1.0",
	"author" => "<a href='http://t.me/amir_Dev' target='_blank' style='color:#0000FF; text-decoration: none;'>امیرحسین فریدوند</a>",
	"language" => "english",
	"fields" => array(
	"key" => array ("FriendlyName" => "Bot Token", "Type" => "text", "Size" => "50", "Description" => "بوت توکن دریافت شده از ربات تلگرام - <a href='https://t.me/RTETM/7' target='_blank' style='color:#0000FF; text-decoration: none;'>آموزش ساخت ربات تلگرام و دریافت Bot Token</a>", "Default" => "", ),
	"chatid" => array ("FriendlyName" => "Chat ID", "Type" => "text", "Size" => "50", "Description" => "چت آی دی تلگرام خود را وارد کنید - <a href='https://t.me/RTETM/8' target='_blank' style='color:#0000FF; text-decoration: none;'>آموزش دریافت Chat ID تلگرام</a>", "Default" => "", ),
	));
	return $configarray;
}
